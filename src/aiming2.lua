...
function aiming2_update(dt)
	...
	if love.keyboard.isDown("up") and gamestate == "player2" and movimentsflag2 then --permite-se mudar o valor do angulo ao pressionar w caso seja a vez deste jogador
	...
	if love.keyboard.isDown("down") and gamestate == "player2" and movimentsflag2 then --permite-se mudar o valor do angulo ao pressionar w caso seja a vez deste jogador
		angle2 = angle2 - anglespeed2 * dt
