...
function shot2_keypressed(key)
	...
	if key == "rctrl" and shotnumber == 0  and not printflag2 and not printflagself2 and not printfloorflag2 then -- limita a ativação do tiro quando não houver balas na tela, assim como impossibilda um novo tiro enquanto um antigo estiver explodindo
